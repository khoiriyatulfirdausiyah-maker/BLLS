...
public class MainActivity extends Activity {
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onShowFileChooser(
                ...
                try {
                    ...
                    Toast.makeText(MainActivity.this, "File manager tidak bisa dibuka.", Toast.LENGTH_SHORT).show();
                    return false;
                }
            }
        });
    ...
    public class AndroidBridge {
        ...
        public void saveJson(final String jsonText, final String filename) {
            runOnUiThread(() -> {
                ...
                pendingJsonFilename = (filename == null || filename.trim().isEmpty())
                        ? "BLLS-backup.json" : filename;
                ...
                try {
                    ...
                    Toast.makeText(MainActivity.this, "Tidak bisa membuka dialog simpan.", Toast.LENGTH_SHORT).show();
                }
            });
        }

        @JavascriptInterface
        public void syncDueNotifications(final String notificationsJson) {
            runOnUiThread(() -> NotificationScheduler.scheduleAll(MainActivity.this, notificationsJson));
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intentData) {
        ...
        if (requestCode == REQUEST_SAVE_JSON) {
            if (resultCode == RESULT_OK && intentData != null &&
                    intentData.getData() != null && pendingJsonText != null) {
                ...
                try (OutputStream os = getContentResolver().openOutputStream(uri, "w")) {
                    ...
                    os.write(pendingJsonText.getBytes(StandardCharsets.UTF_8));
                    os.flush();
                    Toast.makeText(this, "Backup JSON berhasil disimpan.", Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(this, "Backup gagal disimpan.", Toast.LENGTH_LONG).show();
                }
            }
            pendingJsonText = null;
            pendingJsonFilename = null;
